...
del HW4.lst	REM HW4可以替換成.asm檔的檔名
del HW4.obj
del HW4.ilk
del HW4.pdb
del HW4.exe
...
setlocal 
set INCLUDE=D:\ncucc\Downloads\Program\WINdbgFolder;	REM 這裡要設成WINdbgFolder的路徑
set LIB=D:\ncucc\Downloads\Program\WINdbgFolder;
set PATH=D:\ncucc\Downloads\Program\WINdbgFolder;
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:HW4.exe HW4.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
